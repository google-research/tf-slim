...
from tf_slim.layers import feature_column as fc
...
def input_from_feature_columns(columns_to_tensors,
                               ...
                               scope=None,
                               cols_to_outs=None):
  """A tf_slim.layers style input layer builder based on FeatureColumns.
...
def weighted_sum_from_feature_columns(columns_to_tensors,
                                      ...
                                      trainable=True,
                                      scope=None):
  """A tf_slim.layers style linear prediction builder based on FeatureColumn.
