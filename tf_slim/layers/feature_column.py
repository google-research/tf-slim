...
from tf_slim.util import checkpoints as checkpoint_utils
from tf_slim.ops import variables as contrib_variables

from tf_slim.layers import embedding_ops
from tf_slim.layers import layers
from tf_slim.ops import bucketization_op
from tf_slim.ops import sparse_feature_cross_op
from tf_slim.ops import sparse_ops as contrib_sparse_ops
from tf_slim.util import experimental
...
class _SparseColumnKeys(_SparseColumn):
  ...
  def _do_transform(self, input_tensor):
    table = index_table_from_tensor(
        vocabulary_list=tuple(self.lookup_config.keys),
...
def scattered_embedding_column(column_name,
  ...
  could be replaced by
      ...
      scattered_embedding_column(
        ...
        dimension=dimension,
        hash_key=tf_slim.layers.SPARSE_FEATURE_CROSS_DEFAULT_HASH_KEY)
