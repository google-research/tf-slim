...
*   Allows the user to define models much more compactly by eliminating
    ...
    [argument scoping](https://github.com/tensorflow/tensorflow/tree/master/contrib/framework/python/ops/arg_scope.py)
    and numerous high level
    [layers](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
    and
    [variables](https://github.com/tensorflow/tensorflow/tree/master/contrib/framework/python/ops/variables.py).
...
*   Makes developing models simple by providing commonly used
    [regularizers](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/regularizers.py).
*   Several widely used computer vision models (e.g., VGG, AlexNet) have been
    developed in slim, and are
    [available](https://github.com/google-research/tf-slim/tree/master/python/slim/nets/)
...
*   [arg_scope](https://github.com/tensorflow/tensorflow/tree/master/contrib/framework/python/ops/arg_scope.py):
...
*   [data](https://github.com/google-research/tf-slim/tree/master/python/slim/data/):
    contains TF-slim's
    [dataset](https://github.com/google-research/tf-slim/tree/master/python/slim/data/dataset.py)
    definition,
    [data providers](https://github.com/google-research/tf-slim/tree/master/python/slim/data/data_provider.py),
    [parallel_reader](https://github.com/google-research/tf-slim/tree/master/python/slim/data/parallel_reader.py),
    and
    [decoding](https://github.com/google-research/tf-slim/tree/master/python/slim/data/data_decoder.py)
    utilities.
*   [evaluation](https://github.com/google-research/tf-slim/tree/master/python/slim/evaluation.py):
    contains routines for evaluating models.
*   [layers](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py):
    contains high level layers for building models using tensorflow.
*   [learning](https://github.com/google-research/tf-slim/tree/master/python/slim/learning.py):
    contains routines for training models.
*   [losses](https://github.com/tensorflow/tensorflow/tree/master/contrib/losses/python/losses/loss_ops.py):
    contains commonly used loss functions.
*   [metrics](https://github.com/tensorflow/tensorflow/tree/master/contrib/metrics/python/ops/metric_ops.py):
    contains popular evaluation metrics.
*   [nets](https://github.com/google-research/tf-slim/tree/master/python/slim/nets/):
    contains popular network definitions such as
    [VGG](https://github.com/google-research/tf-slim/tree/master/python/slim/nets/vgg.py)
    and
    [AlexNet](https://github.com/google-research/tf-slim/tree/master/python/slim/nets/alexnet.py)
    models.
*   [queues](https://github.com/google-research/tf-slim/tree/master/python/slim/queues.py):
...
[variables.py](https://github.com/tensorflow/tensorflow/tree/master/contrib/framework/python/ops/variables.py)
...
Layer | TF-Slim
------- | --------
BiasAdd  | [slim.bias_add](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
BatchNorm  | [slim.batch_norm](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
Conv2d | [slim.conv2d](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
Conv2dInPlane | [slim.conv2d_in_plane](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
Conv2dTranspose (Deconv) | [slim.conv2d_transpose](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
FullyConnected | [slim.fully_connected](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
AvgPool2D | [slim.avg_pool2d](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
Dropout| [slim.dropout](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
Flatten | [slim.flatten](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
MaxPool2D | [slim.max_pool2d](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
OneHotEncoding | [slim.one_hot_encoding](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
SeparableConv2 | [slim.separable_conv2d](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
UnitNorm | [slim.unit_norm](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
...
function?
[loss_ops.py](https://github.com/tensorflow/tensorflow/tree/master/contrib/losses/python/losses/loss_ops.py)
...
[learning.py](https://github.com/google-research/tf-slim/tree/master/python/slim/learning.py).
...
Note that
[metric_ops.py](https://github.com/tensorflow/tensorflow/tree/master/contrib/metrics/python/ops/metric_ops.py)
can be used in isolation without using either
[layers.py](https://github.com/tensorflow/tensorflow/tree/master/contrib/layers/python/layers/layers.py)
or
[loss_ops.py](https://github.com/tensorflow/tensorflow/tree/master/contrib/losses/python/losses/loss_ops.py)
...
([evaluation.py](https://github.com/google-research/tf-slim/tree/master/python/slim/evaluation.py)),
