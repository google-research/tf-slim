...
from tf_slim.python.slim.data import data_decoder
from tf_slim.python.slim.data import data_provider
from tf_slim.python.slim.data import dataset
from tf_slim.python.slim.data import dataset_data_provider
from tf_slim.python.slim.data import parallel_reader
from tf_slim.python.slim.data import prefetch_queue
from tf_slim.python.slim.data import tfexample_decoder
